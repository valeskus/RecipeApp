...
export function GridListSkeleton(): JSX.Element {
  return (
    ...
    >
      ...
      <Rect x="2%" y="75" rx="20" ry="20" width="45%" height="130" />
      ...
      <Rect x="53%" y="75" rx="20" ry="20" width="45%" height="130" />
      ...
      <Rect x="3%" y="330" rx="20" ry="20" width="45%" height="130" />
      ...
      <Rect x="53%" y="330" rx="20" ry="20" width="45%" height="130" />
      ...
      <Rect x="3%" y="575" rx="20" ry="20" width="45%" height="130" />
      <Rect x="55%" y="575" rx="20" ry="20" width="45%" height="130" />
    </ContentLoader>
  );
}
